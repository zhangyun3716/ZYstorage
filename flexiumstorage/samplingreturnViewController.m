//  samplingreturnViewController.m
//  flexiumstorage
...
@interface samplingreturnViewController ()<NSXMLParserDelegate>

@property (nonatomic, copy) NSString *currentElement;/**< xml标签 */

@property (nonatomic,strong)NSString *currentElementName;/**< xml解析标签名称 */

@property (nonatomic,assign)BOOL isCheck;/**< 是否符号继续 */
...
@property (nonatomic, strong) NSArray *inboxnomessage;/**<内箱信息资料表  */

@property (nonatomic, assign) int httptype;/**< 网络请求类型 */

- (IBAction)beginscan:(UIButton *)sender;/**< 开始扫描 */

@property (strong, nonatomic) IBOutlet UILabel *scanlabletext;/**< 扫描label的text */

@property (strong, nonatomic) IBOutlet UILabel *empnolable;/**<工卡lable  */

@property (strong, nonatomic) IBOutlet UILabel *inboxnolable;/**< 内箱号码lable */

@property (strong, nonatomic) IBOutlet UILabel *fanhuimessage;/**< 返回信息lable */

@end

@implementation samplingreturnViewController
...
-(void)checkinboxno:(NSString *)message{
    ...
    NSString *urlStr = @"http://portal.flexium.com.cn:81/inboxnoreturns.asmx";
