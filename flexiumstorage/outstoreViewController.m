...
@interface outstoreViewController ()<NSXMLParserDelegate,UITableViewDataSource,UITableViewDelegate>
...
@property (nonatomic, copy) NSString *currentElement;/**<xml文件标签解析  */

@property (nonatomic,strong)NSString *currentElementName;/**< xml标签对比 */

@property (nonatomic,assign)BOOL isCheck;/**< 是否符合截取bool */

@property (nonatomic,strong)NSString *returnresult;/**< 返回结果string */

@property (nonatomic, strong) NSXMLParser *parser;/**< xml属性 */

- (IBAction)beginscan:(UIButton *)sender;/**< 开始扫描 */

@property (strong, nonatomic) IBOutlet UILabel *beginscantextlable;/**< 扫描lable文字显示 */
@property (strong, nonatomic) IBOutlet UILabel *empnolable;/**< 工卡号码lable */

@property (strong, nonatomic) IBOutlet UILabel *boxnolable;/**< 外箱号码 */

@property (strong, nonatomic) IBOutlet UILabel *fanhuimessagelable;/**<返回数据lable  */
- (IBAction)querenupdate:(id)sender;/**< 确认开关 */

@property (strong, nonatomic) IBOutlet UITableView *tableview;/**<tableview的定义  */
...
@implementation outstoreViewController
...
- (void)viewDidLoad {
    ...
    NSLog(@"%@",[self huoqudangqianshjian]);
    
    self.title=@"產品出儲位BY正常品";
    ...
    self.billnotableview.estimatedRowHeight = 100;  //  随便设个不那么离谱的值
...
-(void)sapcheckboxno:(NSString *)message{
    ...
    NSString *str1=[NSString stringWithFormat:@"<soapenv:Envelope xmlns:soapenv='http://schemas.xmlsoap.org/soap/envelope/' xmlns:urn='urn:sap-com:document:sap:soap:functions:mc-style'><soapenv:Header/> <soapenv:Body> <urn:Zfpp008> <ExMsg>2011</ExMsg> <ImOutboxno>%@</ImOutboxno> <ImWerks>2011</ImWerks></urn:Zfpp008></soapenv:Body></soapenv:Envelope>",message];
...
-(void)sapreturenworkno:(NSString *)message{
    ...
    NSString *str1=[NSString stringWithFormat:@"<soapenv:Envelope xmlns:soapenv='http://schemas.xmlsoap.org/soap/envelope/' xmlns:urn='urn:sap-com:document:sap:soap:functions:mc-style'><soapenv:Header/><soapenv:Body><urn:Zfpp009><ImPakguser>KEVIN</ImPakguser> <ImRefxtype>A</ImRefxtype><ImWerks>2011</ImWerks><TabBoxno>%@</TabBoxno></urn:Zfpp009></soapenv:Body></soapenv:Envelope>",message];
...
-(void)searchbillsno:(NSString *)message{
    ...
    NSString *str1=[NSString stringWithFormat:@"<?xml version='1.0' encoding='utf-8'?> <soap:Envelope xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/'> <soap:Body><searchbills_no xmlns='http://tempuri.org/'><TYPE>A</TYPE></searchbills_no> </soap:Body> </soap:Envelope>"];
...
- (void)parserDidEndDocument:(NSXMLParser *)parser{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        //2.掃描箱號
            ...
            if ([self.boxnomessage[0] isEqualToString:@"OK"]) {
                ...
                NSString *buliang= self.boxnomessage[2];
                
                NSLog(@"%@---%@",self.boxnomessage,[buliang  substringToIndex:1]);
                
                if([[self.boxnomessage[2]substringToIndex:1]isEqualToString:@"X"]){
                    
                    self.qingqiutype=1;
                    
                    [self tixing:@"該箱號為不良品,請用出儲位by不良品功能出貨"];
    ...
    //3.sap箱號檢查如果没有遇见你，我将会是在哪里，日子过得怎么样，人生是否要珍惜，也许遇见某一人，过着平凡的日子。不知道会不会也有爱情甜如蜜，任时光匆匆流去我只在乎你，心甘情愿感染你的气息，人生几何能够得到知己，失去生命的力量也不可惜，所以我求求你别让我离开你，除了你我不能感到一丝丝情谊。
        ...
        //更新sap返回提單號
            ...
            if (self.sapretrunno.length>2) {
                ...
                [self tixing:self.sapupdatemessagearray[self.sapupdatemessagearray.count-1]];
        ...
        //更新mes數據庫
            ...
            if([_mesupdatemessage[0]isEqualToString:@"OK"]){
                ...
                [self tixing:_mesupdatemessage[1]];
                 ...
                 self.fanhuimessagelable.text=[NSString stringWithFormat:@"%@",self.sapretrunno];
